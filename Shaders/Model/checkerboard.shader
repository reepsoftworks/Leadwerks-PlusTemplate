...
void checkerboard( out vec4 fragColor, in vec2 fragCoord)
{    
    vec2 v = fragCoord.xy;
    vec2 size = vec2(1.0, 0.5);
	vec4 color1 =  vec4(0.32,0.32,0.32,1);
    vec4 color2 =  vec4(0.64, 0.64, 0.64, 1.0);
...
void main(void)
{
	...
	checkerboard(outcolor, ex_texcoords0);
